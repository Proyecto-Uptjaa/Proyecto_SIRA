...
--
-- Current Database: `SIRA_DB`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `SIRA_DB` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `anio_escolar` (
  ...
  CONSTRAINT `anio_escolar_ibfk_1` FOREIGN KEY (`creado_por`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `anio_escolar_ibfk_2` FOREIGN KEY (`cerrado_por`) REFERENCES `usuarios` (`id`)
...
CREATE TABLE `areas_aprendizaje` (
  ...
  `abreviatura` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado` tinyint(1) DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_nombre_area` (`nombre`)
...
CREATE TABLE `empleados` (
  ...
  `talla_camisa` varchar(3) DEFAULT NULL,
  `talla_pantalon` varchar(3) DEFAULT NULL,
  `talla_zapatos` int DEFAULT NULL,
  `actividad` varchar(100) DEFAULT NULL,
  `cultural` varchar(100) DEFAULT NULL,
  `tipo_vivienda` varchar(50) DEFAULT NULL,
  `condicion_vivienda` varchar(50) DEFAULT NULL,
  `material_vivienda` varchar(50) DEFAULT NULL,
...
CREATE TABLE `materias` (
  ...
  `abreviatura` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tipo_evaluacion` enum('numerico','literal') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'numerico',
  `area_aprendizaje_id` int DEFAULT NULL,
  `estado` tinyint(1) DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_nombre` (`nombre`),
  KEY `fk_materia_area` (`area_aprendizaje_id`),
  CONSTRAINT `fk_materia_area` FOREIGN KEY (`area_aprendizaje_id`) REFERENCES `areas_aprendizaje` (`id`) ON DELETE SET NULL
...
CREATE TABLE `notas` (
  ...
  `nota_literal` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `notas_finales` (
  ...
  `nota_final_literal` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `secciones` (
  ...
  CONSTRAINT `fk_secciones_año_escolar` FOREIGN KEY (`año_escolar_id`) REFERENCES `anio_escolar` (`id`)
