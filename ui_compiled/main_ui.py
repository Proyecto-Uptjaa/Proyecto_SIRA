...
"}")
        ...
        self.btnHistorial_estudiantes = QPushButton(self.estudiantes)
        self.btnHistorial_estudiantes.setObjectName(u"btnHistorial_estudiantes")
        self.btnHistorial_estudiantes.setGeometry(QRect(10, 200, 171, 50))
        sizePolicy1.setHeightForWidth(self.btnHistorial_estudiantes.sizePolicy().hasHeightForWidth())
        self.btnHistorial_estudiantes.setSizePolicy(sizePolicy1)
        self.btnHistorial_estudiantes.setMinimumSize(QSize(80, 50))
        self.btnHistorial_estudiantes.setMaximumSize(QSize(200, 50))
        self.btnHistorial_estudiantes.setFont(font)
        self.btnHistorial_estudiantes.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.btnHistorial_estudiantes.setToolTipDuration(-1)
        self.btnHistorial_estudiantes.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.btnHistorial_estudiantes.setStyleSheet(u"QPushButton {\n"
"   background: transparent;\n"
"    color: #FFFFFF;\n"
"    border: none;\n"
"    padding: 8px 16px;\n"
...
"}")
        icon10 = QIcon()
        icon10.addFile(u":/icons/historial_w.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon10.addFile(u":/icons/historial_b.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.btnHistorial_estudiantes.setIcon(icon10)
        self.btnHistorial_estudiantes.setIconSize(QSize(50, 50))
        self.btnHistorial_estudiantes.setCheckable(True)
        self.btnHistorial_estudiantes.setChecked(False)
...
"}")
        icon12 = QIcon()
        icon12.addFile(u":/icons/permisos_w.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon12.addFile(u":/icons/permisos_b.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.btnRoles.setIcon(icon12)
...
"}")
        icon13 = QIcon()
        icon13.addFile(u":/icons/auditoria_w.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon13.addFile(u":/icons/auditoria_b.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.btnAuditoria.setIcon(icon13)
...
"}")
        icon14 = QIcon()
        icon14.addFile(u":/icons/datos_institucion_w.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon14.addFile(u":/icons/datos_institucion_b.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.btnDatos_institucion.setIcon(icon14)
...
"}")
        icon15 = QIcon()
        icon15.addFile(u":/icons/copia_seguridad_w.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon15.addFile(u":/icons/copia_seguridad_b.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.btnCopia_seguridad.setIcon(icon15)
...
"}")
        ...
        self.lblAnio_escolar_main = QLabel(self.menuFrame)
        self.lblAnio_escolar_main.setObjectName(u"lblAnio_escolar_main")
        self.lblAnio_escolar_main.setGeometry(QRect(0, 590, 161, 31))
        font3 = QFont()
        font3.setFamilies([u"Segoe UI"])
        font3.setPointSize(10)
        font3.setBold(True)
        self.lblAnio_escolar_main.setFont(font3)
        self.lblAnio_escolar_main.setStyleSheet(u"color: #f5f6fa;\n"
"background-color: transparent;")
        self.lblAnio_escolar_main.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.lblAnio_escolar_main.setWordWrap(True)
...
"color: #2d2d2d;")
        ...
        self.frameSaludo.setGeometry(QRect(40, 20, 541, 161))
...
"}")
        ...
        self.frameAccesosDirectos.setGeometry(QRect(600, 90, 391, 481))
...
"}")
        ...
        self.btnAccesoDirecto_reg_estu.setGeometry(QRect(30, 360, 71, 51))
...
"}")
        ...
        self.lblResumenGeneral_7.setGeometry(QRect(0, 260, 391, 51))
        ...
        self.btnAccesoDirecto_reg_emple.setGeometry(QRect(165, 360, 71, 51))
...
"}")
        ...
        self.btnAccesoDirecto_secciones.setGeometry(QRect(290, 360, 71, 51))
...
"}")
        ...
        self.frMatricula_home.setGeometry(QRect(50, 310, 230, 111))
        self.frMatricula_home.setMinimumSize(QSize(230, 0))
        self.frMatricula_home.setMaximumSize(QSize(230, 16777215))
...
"}")
        ...
        self.lblTarjeta1_Titulo.setGeometry(QRect(30, 10, 171, 31))
        self.lblTarjeta1_Titulo.setFont(font3)
        ...
        self.lblMatricula_home.setGeometry(QRect(60, 40, 111, 51))
        font7 = QFont()
        ...
        self.lineSeparadora.setGeometry(QRect(30, 220, 560, 3))
        self.lineSeparadora.setMinimumSize(QSize(560, 3))
        ...
        self.frRepresentantes_home.setGeometry(QRect(330, 310, 230, 111))
        self.frRepresentantes_home.setMinimumSize(QSize(230, 0))
        self.frRepresentantes_home.setMaximumSize(QSize(230, 16777215))
...
"}")
        ...
        self.lblTarjeta1_Titulo_3.setGeometry(QRect(30, 10, 171, 31))
        self.lblTarjeta1_Titulo_3.setFont(font3)
        ...
        self.lblRepresentantes_home.setGeometry(QRect(60, 40, 111, 51))
        ...
        self.frTrabajadores_home.setGeometry(QRect(50, 450, 230, 111))
        self.frTrabajadores_home.setMinimumSize(QSize(230, 0))
        self.frTrabajadores_home.setMaximumSize(QSize(230, 16777215))
...
"}")
        ...
        self.lblTarjeta1_Titulo_4.setGeometry(QRect(30, 10, 171, 31))
        self.lblTarjeta1_Titulo_4.setFont(font3)
        ...
        self.lblEmpleados_home.setGeometry(QRect(60, 40, 111, 51))
        ...
        self.frSeccion_home.setGeometry(QRect(330, 450, 230, 111))
        self.frSeccion_home.setMinimumSize(QSize(230, 0))
        self.frSeccion_home.setMaximumSize(QSize(230, 16777215))
...
"}")
        ...
        self.lblTarjeta1_Titulo_5.setGeometry(QRect(30, 10, 181, 31))
        self.lblTarjeta1_Titulo_5.setFont(font3)
        ...
        self.lblSeccion_home.setGeometry(QRect(40, 30, 181, 71))
        font8 = QFont()
        font8.setFamilies([u"Segoe UI"])
        font8.setPointSize(23)
        font8.setBold(True)
        self.lblSeccion_home.setFont(font8)
...
"background-color: transparent;")
        ...
        font9.setBold(True)
        self.lblTitulo_logo_estu_2.setFont(font9)
        ...
        self.lblLogo_estu_2 = QLabel(self.home)
        self.lblLogo_estu_2.setObjectName(u"lblLogo_estu_2")
        self.lblLogo_estu_2.setGeometry(QRect(1039, 10, 51, 61))
        self.lblLogo_estu_2.setMinimumSize(QSize(50, 50))
        self.lblLogo_estu_2.setMaximumSize(QSize(130, 70))
        self.lblLogo_estu_2.setPixmap(QPixmap(u":/logos/logo_escuela_sinFondo.png"))
        self.lblLogo_estu_2.setScaledContents(True)
...
"")
        ...
        font10.setBold(True)
        self.cbxCriterio.setFont(font10)
...
"")
        ...
        self.cbxTipoGrafica.setFont(font10)
...
"")
        ...
        self.cbxPoblacion.setFont(font10)
...
"}")
        ...
        self.lblTitulo_logo_emple_2.setFont(font9)
...
"")
        ...
        self.cbxSeccion_reporte.setFont(font10)
        ...
        self.lblSeccion_reporte.setFont(font11)
...
"}")
        ...
        self.lblTitulo_logo_emple_3.setFont(font9)
        ...
        self.lblInactivos_usuarios.setGeometry(QRect(390, 590, 61, 31))
        font12 = QFont()
        ...
        self.lblTarjeta1_Titulo_11.setFont(font3)
...
"}")
        ...
        self.btnActualizar_db_user = QPushButton(self.admin_gestion_usuarios)
        self.btnActualizar_db_user.setObjectName(u"btnActualizar_db_user")
        self.btnActualizar_db_user.setGeometry(QRect(930, 520, 51, 35))
        sizePolicy1.setHeightForWidth(self.btnActualizar_db_user.sizePolicy().hasHeightForWidth())
        self.btnActualizar_db_user.setSizePolicy(sizePolicy1)
        self.btnActualizar_db_user.setMinimumSize(QSize(20, 20))
        self.btnActualizar_db_user.setMaximumSize(QSize(150, 50))
        font14 = QFont()
        font14.setFamilies([u"Questrial"])
        font14.setBold(True)
        self.btnActualizar_db_user.setFont(font14)
        self.btnActualizar_db_user.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.btnActualizar_db_user.setMouseTracking(True)
        self.btnActualizar_db_user.setTabletTracking(False)
        self.btnActualizar_db_user.setAcceptDrops(False)
        self.btnActualizar_db_user.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.btnActualizar_db_user.setAutoFillBackground(False)
        self.btnActualizar_db_user.setStyleSheet(u"QPushButton {\n"
...
"}")
        ...
        self.btnActualizar_db_user.setIcon(icon24)
        self.btnActualizar_db_user.setIconSize(QSize(60, 60))
        ...
        self.lblTarjeta1_Titulo_12.setFont(font3)
        ...
        self.lblActivos_usuarios.setGeometry(QRect(160, 590, 61, 31))
...
"}")
        ...
        self.lblTitulo_logo_emple_4.setFont(font9)
...
"}")
        ...
        self.lblTitulo_logo_emple_5.setFont(font9)
...
"border: transparent;")
        ...
        self.lblTitulo_logo_emple_6.setFont(font9)
        ...
        font15.setBold(True)
        self.lblTitulo_logo_emple_7.setFont(font15)
        ...
        self.lblTitulo_logo_emple_8.setFont(font3)
...
"}")
        ...
        self.btnModificar_institucion_2.setIcon(icon25)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnUsuario_home.setToolTip(QCoreApplication.translate("MainWindow", u"Usuario", None))
#endif // QT_CONFIG(tooltip)
        self.btnUsuario_home.setText(QCoreApplication.translate("MainWindow", u"Usuario", None))
#if QT_CONFIG(tooltip)
        self.btnAdmin.setToolTip(QCoreApplication.translate("MainWindow", u"Administracion de sistema", None))
#endif // QT_CONFIG(tooltip)
        self.btnAdmin.setText(QCoreApplication.translate("MainWindow", u"Admin", None))
#if QT_CONFIG(tooltip)
        self.btnReportes.setToolTip(QCoreApplication.translate("MainWindow", u"Reportes estadisticos", None))
#endif // QT_CONFIG(tooltip)
        self.btnReportes.setText(QCoreApplication.translate("MainWindow", u"Reportes", None))
#if QT_CONFIG(tooltip)
        self.btnEmpleados.setToolTip(QCoreApplication.translate("MainWindow", u"Modulo empleados", None))
#endif // QT_CONFIG(tooltip)
        self.btnEmpleados.setText(QCoreApplication.translate("MainWindow", u"Empleados", None))
#if QT_CONFIG(tooltip)
        self.btnEstudiantes.setToolTip(QCoreApplication.translate("MainWindow", u"Modulo estudiantes", None))
#endif // QT_CONFIG(tooltip)
        self.btnEstudiantes.setText(QCoreApplication.translate("MainWindow", u"Estudiantes", None))
#if QT_CONFIG(tooltip)
        self.btnHome.setToolTip(QCoreApplication.translate("MainWindow", u"Home", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.btnHistorial_estudiantes.setToolTip(QCoreApplication.translate("MainWindow", u"Modulo estudiantes", None))
#endif // QT_CONFIG(tooltip)
        self.btnHistorial_estudiantes.setText(QCoreApplication.translate("MainWindow", u"Historial", None))
#if QT_CONFIG(tooltip)
...
"seguridad", None))
        ...
        self.lblAnio_escolar_main.setText(QCoreApplication.translate("MainWindow", u"A\u00f1o escolar:", None))
        ...
        self.lblSeccion_home.setText(QCoreApplication.translate("MainWindow", u"000", None))
        ...
        self.lblTarjeta1_Titulo_11.setText(QCoreApplication.translate("MainWindow", u"Total usuarios inactivos:", None))
        self.chkMostrar_inactivos_user.setText(QCoreApplication.translate("MainWindow", u"Mostrar inactivos", None))
        self.btnActualizar_db_user.setText("")
        self.lblTarjeta1_Titulo_12.setText(QCoreApplication.translate("MainWindow", u"Total usuarios activos:", None))
