...
################################################################################
## Form generated from reading UI file 'anio_escolar_1024x600.ui'
##
...
class Ui_anio_escolar(object):
    def setupUi(self, anio_escolar):
        ...
        anio_escolar.resize(841, 511)
        anio_escolar.setMinimumSize(QSize(841, 511))
        anio_escolar.setMaximumSize(QSize(841, 511))
...
"color: #2d2d2d;")
        ...
        self.lblTitulo_anios.setGeometry(QRect(600, 10, 151, 61))
        font = QFont()
...
"background-color: transparent;")
        ...
        self.lblLogo_anios.setGeometry(QRect(769, 10, 51, 61))
        ...
        self.btnAperturar_anio.setGeometry(QRect(230, 210, 311, 50))
...
"}")
        ...
        self.lblTitulo_logo_estu_2.setGeometry(QRect(171, 30, 421, 81))
        font2 = QFont()
        font2.setFamilies([u"Segoe UI"])
        font2.setPointSize(19)
        font2.setBold(True)
        self.lblTitulo_logo_estu_2.setFont(font2)
...
"background-color: transparent;")
        ...
        self.lblTitulo_logo_estu_3.setGeometry(QRect(171, 110, 431, 81))
        font3 = QFont()
        font3.setFamilies([u"Segoe UI"])
        font3.setPointSize(11)
        font3.setBold(True)
        self.lblTitulo_logo_estu_3.setFont(font3)
...
"background-color: transparent;")
        ...
        self.lblIcon_conectado_como.setGeometry(QRect(650, 80, 16, 16))
        font4 = QFont()
        font4.setFamilies([u"Segoe UI"])
        font4.setPointSize(8)
        font4.setBold(True)
        self.lblIcon_conectado_como.setFont(font4)
        ...
        self.lblConectado_como.setGeometry(QRect(670, 80, 161, 16))
        self.lblConectado_como.setFont(font4)
