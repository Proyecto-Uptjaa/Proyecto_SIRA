...
################################################################################
## Form generated from reading UI file 'gestion_notas_1024x600.ui'
##
...
class Ui_gestion_notas(object):
    def setupUi(self, gestion_notas):
        ...
        gestion_notas.resize(841, 511)
        gestion_notas.setMinimumSize(QSize(841, 511))
        gestion_notas.setMaximumSize(QSize(841, 511))
...
"color: #2d2d2d;")
        ...
        self.frameHeader.setGeometry(QRect(9, 3, 821, 55))
...
"background-color: transparent;")
        ...
        self.frameHeader_2.setGeometry(QRect(9, 62, 821, 51))
...
"}")
        ...
        self.widgetSecciones_notas.setGeometry(QRect(10, 10, 811, 81))
        ...
        self.frameHeader_3.setGeometry(QRect(0, 0, 821, 31))
...
"background-color: transparent;")
        ...
        self.frameHeader_4.setGeometry(QRect(0, 30, 821, 60))
...
"}")
        ...
        self.frameTabla_notas.setGeometry(QRect(0, 90, 821, 181))
        self.frameTabla_notas.setMinimumSize(QSize(821, 150))
        self.frameTabla_notas.setMaximumSize(QSize(821, 401))
