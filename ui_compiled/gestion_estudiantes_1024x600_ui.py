...
"}")
        ...
        self.lblInactivos_estu.setGeometry(QRect(480, 480, 61, 31))
        font5 = QFont()
        ...
        self.lblActivos_estu.setGeometry(QRect(310, 480, 61, 31))
        ...
        self.lblTarjeta1_Titulo_8.setGeometry(QRect(380, 480, 111, 31))
        font6 = QFont()
        ...
        self.lblTotalRegistros_estu.setGeometry(QRect(120, 480, 61, 31))
        ...
        self.lblTarjeta1_Titulo_7.setGeometry(QRect(210, 480, 111, 31))
        ...
        self.lblTotalRegistros.setGeometry(QRect(20, 480, 111, 31))
