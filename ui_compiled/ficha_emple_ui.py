...
"border: transparent;")
        ...
        self.lneRAC_ficha_emple.setGeometry(QRect(100, 220, 151, 30))
        ...
        self.lneCarnet_ficha_emple.setGeometry(QRect(650, 170, 151, 30))
        ...
        self.lneHoras_adm_ficha_emple = QLineEdit(self.representante)
        self.lneHoras_adm_ficha_emple.setObjectName(u"lneHoras_adm_ficha_emple")
        self.lneHoras_adm_ficha_emple.setGeometry(QRect(680, 220, 60, 30))
        ...
        self.lneHoras_aca_ficha_emple = QLineEdit(self.representante)
        self.lneHoras_aca_ficha_emple.setObjectName(u"lneHoras_aca_ficha_emple")
        self.lneHoras_aca_ficha_emple.setGeometry(QRect(420, 220, 60, 30))
        ...
        self.frmTitulo_emple_3.setGeometry(QRect(110, 170, 400, 30))
...
"")
        ...
        self.cbxEspecialidad_ficha_emple.setFont(font1)
        self.cbxEspecialidad_ficha_emple.setStyleSheet(u"background-color: white;\n"
"border: transparent;")
        ...
        self.lblEspecialidad_reg_emple.setGeometry(QRect(0, 170, 101, 30))
...
"")
        ...
        self.cbxTipoPersonal_ficha_emple.setGeometry(QRect(5, 4, 50, 20))
        ...
        self.cbxTipoPersonal_ficha_emple.setStyleSheet(u"background-color: white;\n"
"border: transparent;")
...
"}")
        ...
        self.lblTitulo_ficha_emple.setGeometry(QRect(761, 10, 131, 81))
        font6 = QFont()
        font6.setFamilies([u"Segoe UI"])
        font6.setPointSize(19)
        font6.setBold(True)
        self.lblTitulo_ficha_emple.setFont(font6)
...
"background-color: transparent;")
        ...
        self.lblLogo_ficha_emple.setGeometry(QRect(910, 20, 51, 61))
        self.lblLogo_ficha_emple.setMinimumSize(QSize(50, 50))
        self.lblLogo_ficha_emple.setMaximumSize(QSize(130, 70))
...
"}")
        ...
        self.lblTitulo_ficha_emple.raise_()
        self.line_2.raise_()
        self.lblLogo_ficha_emple.raise_()
    ...
    def retranslateUi(self, ficha_emple):
        ...
        self.lneHoras_adm_ficha_emple.setPlaceholderText("")
        self.lneHoras_aca_ficha_emple.setText("")
        self.lneHoras_aca_ficha_emple.setPlaceholderText("")
