...
################################################################################
## Form generated from reading UI file 'detalle_egresado.ui'
##
...
class Ui_detalle_egresado(object):
    def setupUi(self, detalle_egresado):
        if not detalle_egresado.objectName():
            detalle_egresado.setObjectName(u"detalle_egresado")
        detalle_egresado.resize(1000, 600)
        detalle_egresado.setMinimumSize(QSize(1000, 600))
        detalle_egresado.setMaximumSize(QSize(1000, 600))
        detalle_egresado.setStyleSheet(u"background-color: #f5f6fa;")
        self.gridLayout = QGridLayout(detalle_egresado)
        self.gridLayout.setObjectName(u"gridLayout")
        self.widget = QWidget(detalle_egresado)
...
"}")
        ...
        self.stackFicha_estu.setStyleSheet(u"background-color: transparent;\n"
"color: #2d2d2d;")
        ...
        self.lneApellido_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneNombre_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneCity_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneEdad_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneDir_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.label_33.setGeometry(QRect(510, 190, 61, 30))
        ...
        self.label_34.setGeometry(QRect(690, 190, 61, 30))
        ...
        self.lneDocente_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneTallaC_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneTallaP_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneTallaZ_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
...
"")
        ...
        self.frGrado_reg_estu_2.setGeometry(QRect(400, 190, 101, 30))
...
"")
        ...
        self.cbxTipoEdu_ficha_estu = QComboBox(self.frGrado_reg_estu_2)
...
"border: transparent;")
        ...
        self.label_31.setGeometry(QRect(270, 190, 121, 30))
        ...
        self.lneMadre_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lnePadre_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneCedula_madre_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneCedula_padre_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
...
"color: #2d2d2d;")
        ...
        self.lneApellidos_repre_ficha_estu = QLineEdit(self.widget_2)
        ...
        self.lneApellidos_repre_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneNombres_repre_ficha_estu = QLineEdit(self.widget_2)
        ...
        self.lneNombres_repre_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneDir_repre_ficha_estu = QLineEdit(self.widget_2)
        ...
        self.lneDir_repre_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneEdad_repre_ficha_estu = QLineEdit(self.widget_2)
        ...
        self.lneEdad_repre_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneNum_repre_ficha_estu = QLineEdit(self.widget_2)
        ...
        self.lneNum_repre_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneCedula_repre_ficha_estu = QLineEdit(self.widget_2)
        ...
        self.lneCedula_repre_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneCorreo_repre_ficha_estu = QLineEdit(self.widget_2)
        ...
        self.lneCorreo_repre_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneFechaNac_repre_ficha_estu = QDateEdit(self.widget_2)
...
"")
        ...
        self.lneObser_ficha_estu_repre = QLineEdit(self.widget_2)
        ...
        self.lneObser_ficha_estu_repre.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneOcup_madre_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.lneOcup_padre_ficha_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        ...
        self.pestanas_ficha = QButtonGroup(detalle_egresado)
...
"}")
        ...
        self.lblLogo_estu.setGeometry(QRect(919, 20, 51, 61))
        ...
        self.lblTitulo_logo_estu.setGeometry(QRect(760, 10, 141, 81))
        font8 = QFont()
        font8.setFamilies([u"Segoe UI"])
        font8.setPointSize(19)
        font8.setBold(True)
        self.lblTitulo_logo_estu.setFont(font8)
        ...
        self.btnEliminar_ficha_estu.setGeometry(QRect(550, 520, 120, 40))
...
"background-color: transparent;")
        ...
        self.retranslateUi(detalle_egresado)

        self.stackFicha_estu.setCurrentIndex(0)


        QMetaObject.connectSlotsByName(detalle_egresado)
    # setupUi

    def retranslateUi(self, detalle_egresado):
        detalle_egresado.setWindowTitle(QCoreApplication.translate("detalle_egresado", u"Dialog", None))
        self.lneCedula_ficha_estu.setText("")
        self.lneCedula_ficha_estu.setPlaceholderText("")
        self.lblStudent_apellido.setText(QCoreApplication.translate("detalle_egresado", u"Apellidos", None))
        ...
        self.lblStudent_nombres.setText(QCoreApplication.translate("detalle_egresado", u"Nombres", None))
        self.lblStudent_lugarNac.setText(QCoreApplication.translate("detalle_egresado", u"Lugar Nac.", None))
        self.lblStudent_fechaNac.setText(QCoreApplication.translate("detalle_egresado", u"Fecha Nac.", None))
        ...
        self.lblStudent_edad.setText(QCoreApplication.translate("detalle_egresado", u"Edad", None))
        self.lblStudent_genero.setText(QCoreApplication.translate("detalle_egresado", u"G\u00e9nero", None))
        self.lneDir_ficha_estu.setText("")
        self.lneDir_ficha_estu.setPlaceholderText("")
        self.lblStudent_dir.setText(QCoreApplication.translate("detalle_egresado", u"Direcci\u00f3n", None))
        self.label_33.setText(QCoreApplication.translate("detalle_egresado", u"Grado", None))
        self.label_34.setText(QCoreApplication.translate("detalle_egresado", u"Secci\u00f3n", None))
        self.lneDocente_ficha_estu.setText("")
        self.lneDocente_ficha_estu.setPlaceholderText("")
        self.label_35.setText(QCoreApplication.translate("detalle_egresado", u"Docente", None))
        self.label_42.setText(QCoreApplication.translate("detalle_egresado", u"Talla Camisa", None))
        self.lneTallaC_ficha_estu.setText("")
        self.lneTallaC_ficha_estu.setPlaceholderText("")
        self.label_44.setText(QCoreApplication.translate("detalle_egresado", u"Talla Pantal\u00f3n", None))
        ...
        self.label_49.setText(QCoreApplication.translate("detalle_egresado", u"Talla Zapatos", None))
        self.lneFechaNac_ficha_estu.setDisplayFormat(QCoreApplication.translate("detalle_egresado", u"dd-MM-yyyy", None))
        self.cbxSeccion_ficha_estu.setItemText(0, QCoreApplication.translate("detalle_egresado", u"A", None))
        self.cbxSeccion_ficha_estu.setItemText(1, QCoreApplication.translate("detalle_egresado", u"B", None))
        self.cbxSeccion_ficha_estu.setItemText(2, QCoreApplication.translate("detalle_egresado", u"C", None))

        self.cbxGrado_ficha_estu.setItemText(0, "")
        self.cbxGrado_ficha_estu.setItemText(1, QCoreApplication.translate("detalle_egresado", u"1ero", None))
        self.cbxGrado_ficha_estu.setItemText(2, QCoreApplication.translate("detalle_egresado", u"2do", None))
        self.cbxGrado_ficha_estu.setItemText(3, QCoreApplication.translate("detalle_egresado", u"3ro", None))
        self.cbxGrado_ficha_estu.setItemText(4, QCoreApplication.translate("detalle_egresado", u"4to", None))
        self.cbxGrado_ficha_estu.setItemText(5, QCoreApplication.translate("detalle_egresado", u"5to", None))
        self.cbxGrado_ficha_estu.setItemText(6, QCoreApplication.translate("detalle_egresado", u"6to", None))

        self.cbxGenero_ficha_estu.setItemText(0, "")
        self.cbxGenero_ficha_estu.setItemText(1, QCoreApplication.translate("detalle_egresado", u"M", None))
        self.cbxGenero_ficha_estu.setItemText(2, QCoreApplication.translate("detalle_egresado", u"F", None))

        self.lblStudent_fechaIng.setText(QCoreApplication.translate("detalle_egresado", u"Fecha Ing.", None))
        self.lneFechaIng_ficha_estu.setDisplayFormat(QCoreApplication.translate("detalle_egresado", u"dd-MM-yyyy", None))
        self.cbxTipoEdu_ficha_estu.setItemText(0, "")
        self.cbxTipoEdu_ficha_estu.setItemText(1, QCoreApplication.translate("detalle_egresado", u"Inicial", None))
        self.cbxTipoEdu_ficha_estu.setItemText(2, QCoreApplication.translate("detalle_egresado", u"Primaria", None))

        self.label_31.setText(QCoreApplication.translate("detalle_egresado", u"Tipo educaci\u00f3n", None))
        self.lneMadre_ficha_estu.setText("")
        self.lneMadre_ficha_estu.setPlaceholderText("")
        self.lblStudent_apellido_repre_2.setText(QCoreApplication.translate("detalle_egresado", u"Madre", None))
        self.lnePadre_ficha_estu.setText("")
        self.lnePadre_ficha_estu.setPlaceholderText("")
        self.lblStudent_nombres_3.setText(QCoreApplication.translate("detalle_egresado", u"Padre", None))
        self.lblStudent_fechaNac_repre_2.setText(QCoreApplication.translate("detalle_egresado", u"Cedula Madre", None))
        ...
        self.lblStudent_fechaNac_repre_3.setText(QCoreApplication.translate("detalle_egresado", u"Cedula Padre", None))
        self.lblStudent_nombres_2.setText(QCoreApplication.translate("detalle_egresado", u"Nombres", None))
        self.lneApellidos_repre_ficha_estu.setText("")
        self.lneApellidos_repre_ficha_estu.setPlaceholderText("")
        self.lblStudent_apellido_repre.setText(QCoreApplication.translate("detalle_egresado", u"Apellidos", None))
        self.lneNombres_repre_ficha_estu.setText("")
        self.lneNombres_repre_ficha_estu.setPlaceholderText("")
        self.lblStudent_dir_repre.setText(QCoreApplication.translate("detalle_egresado", u"Direcci\u00f3n", None))
        ...
        self.label_41.setText(QCoreApplication.translate("detalle_egresado", u"Num. Contact.", None))
        self.lneNum_repre_ficha_estu.setText("")
        self.lneNum_repre_ficha_estu.setPlaceholderText("")
        self.lblStudent_fechaNac_repre.setText(QCoreApplication.translate("detalle_egresado", u"Fecha Nac.", None))
        self.lblStudent_edad_repre.setText(QCoreApplication.translate("detalle_egresado", u"Edad", None))
        ...
        self.label_38.setText(QCoreApplication.translate("detalle_egresado", u"Correo Elect.", None))
        self.lblStudent_genero_repre.setText(QCoreApplication.translate("detalle_egresado", u"G\u00e9nero", None))
        self.lblTitulo_registro_estudiante_2.setText(QCoreApplication.translate("detalle_egresado", u"Datos representante", None))
        self.lblStudent_fechaNac_repre_4.setText(QCoreApplication.translate("detalle_egresado", u"Cedula", None))
        self.lneFechaNac_repre_ficha_estu.setDisplayFormat(QCoreApplication.translate("detalle_egresado", u"dd-MM-yyyy", None))
        self.cbxGenero_repre_ficha_estu.setItemText(0, "")
        self.cbxGenero_repre_ficha_estu.setItemText(1, QCoreApplication.translate("detalle_egresado", u"M", None))
        self.cbxGenero_repre_ficha_estu.setItemText(2, QCoreApplication.translate("detalle_egresado", u"F", None))

        self.lblStudent_dir_repre_2.setText(QCoreApplication.translate("detalle_egresado", u"Observaci\u00f3n:", None))
        ...
        self.lblStudent_fechaNac_repre_6.setText(QCoreApplication.translate("detalle_egresado", u"Ocupaci\u00f3n", None))
        self.lblStudent_fechaNac_repre_5.setText(QCoreApplication.translate("detalle_egresado", u"Ocupaci\u00f3n", None))
#if QT_CONFIG(tooltip)
        self.btnStudentDatos_ficha.setToolTip(QCoreApplication.translate("detalle_egresado", u"Home", None))
#endif // QT_CONFIG(tooltip)
        self.btnStudentDatos_ficha.setText(QCoreApplication.translate("detalle_egresado", u"Datos personales", None))
#if QT_CONFIG(tooltip)
        self.btnRepre_ficha.setToolTip(QCoreApplication.translate("detalle_egresado", u"Home", None))
#endif // QT_CONFIG(tooltip)
        self.btnRepre_ficha.setText(QCoreApplication.translate("detalle_egresado", u"Datos Representante", None))
        self.btnModificar_ficha_estu.setText(QCoreApplication.translate("detalle_egresado", u"Modificar", None))
        self.btnExportar_ficha_estu.setText(QCoreApplication.translate("detalle_egresado", u"Generar PDF", None))
        self.lblLogo_estu.setText("")
        self.lblTitulo_logo_estu.setText(QCoreApplication.translate("detalle_egresado", u"Detalle de egresado", None))
        self.btnEliminar_ficha_estu.setText(QCoreApplication.translate("detalle_egresado", u"Eliminar", None))
        self.lblCedula_registro_estudiante.setText(QCoreApplication.translate("detalle_egresado", u"C\u00e9dula Estudiantil", None))
    # retranslateUi
