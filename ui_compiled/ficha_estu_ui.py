...
"}")
        ...
        self.lblTitulo_logo_estu.setGeometry(QRect(760, 20, 141, 61))
        font8 = QFont()
...
"}")
    ...
    def retranslateUi(self, ficha_estu):
        ...
        self.lblTitulo_logo_estu.setText(QCoreApplication.translate("ficha_estu", u"Ficha de estudiante", None))
