...
"}")
        ...
        self.lblTitulo_login.setGeometry(QRect(60, 40, 181, 51))
...
"}")
        ...
        self.btnAperturar.setGeometry(QRect(60, 170, 200, 35))
...
"}")
        ...
        self.frameAnio_nuevo.setGeometry(QRect(40, 110, 230, 40))
...
"")
        ...
        self.cbxAnio_nuevo.setStyleSheet(u"border: transparent;")
        ...
        self.btnCancelar.setGeometry(QRect(90, 220, 141, 35))
