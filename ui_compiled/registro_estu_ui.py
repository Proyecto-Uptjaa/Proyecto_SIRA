...
"}")
        ...
        self.lneDocente_reg_estu = QLineEdit(self.personal_data)
        self.lneDocente_reg_estu.setObjectName(u"lneDocente_reg_estu")
        self.lneDocente_reg_estu.setGeometry(QRect(110, 240, 241, 30))
        self.lneDocente_reg_estu.setMinimumSize(QSize(100, 30))
        self.lneDocente_reg_estu.setMaximumSize(QSize(400, 30))
        self.lneDocente_reg_estu.setFont(font)
        self.lneDocente_reg_estu.setFocusPolicy(Qt.FocusPolicy.ClickFocus)
        self.lneDocente_reg_estu.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #2980b9;\n"
"    border-radius: 10px;\n"
"    padding: 3px 8px;\n"
"    background-color: white;\n"
"}")
        self.lneDocente_reg_estu.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.label_35 = QLabel(self.personal_data)
        self.label_35.setObjectName(u"label_35")
        self.label_35.setGeometry(QRect(0, 240, 121, 30))
...
"}")
    ...
    def retranslateUi(self, registro_estu):
        ...
        self.lneDocente_reg_estu.setText("")
        self.lneDocente_reg_estu.setPlaceholderText("")
        self.label_35.setText(QCoreApplication.translate("registro_estu", u"Docente", None))
