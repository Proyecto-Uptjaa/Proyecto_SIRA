...
"color: #2d2d2d;")
        self.lblTitulo_logo_emple = QLabel(gestion_empleados)
        self.lblTitulo_logo_emple.setObjectName(u"lblTitulo_logo_emple")
        self.lblTitulo_logo_emple.setGeometry(QRect(880, 0, 141, 81))
        font = QFont()
        font.setFamilies([u"Segoe UI"])
        font.setPointSize(19)
        font.setBold(True)
        self.lblTitulo_logo_emple.setFont(font)
        self.lblTitulo_logo_emple.setStyleSheet(u"color: #2d2d2d")
        self.lblTitulo_logo_emple.setFrameShape(QFrame.Shape.NoFrame)
        self.lblTitulo_logo_emple.setFrameShadow(QFrame.Shadow.Plain)
        self.lblTitulo_logo_emple.setScaledContents(False)
        self.lblTitulo_logo_emple.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
        self.lblTitulo_logo_emple.setWordWrap(True)
        self.lblTitulo_logo_emple.setIndent(0)
...
"border: transparent;")
    ...
    def retranslateUi(self, gestion_empleados):
        ...
        self.lblTitulo_logo_emple.setText(QCoreApplication.translate("gestion_empleados", u"M\u00f3dulo de empleados", None))
