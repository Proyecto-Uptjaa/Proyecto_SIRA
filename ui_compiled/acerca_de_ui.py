...
"}")
        ...
        self.lblLogo_estu.setGeometry(QRect(315, 20, 90, 80))
        self.lblLogo_estu.setMinimumSize(QSize(90, 80))
        self.lblLogo_estu.setMaximumSize(QSize(90, 80))
        self.lblLogo_estu.setPixmap(QPixmap(u":/logos/logo_uptjaa.png"))
...
"background-color: transparent;")
        ...
        self.lblTitulo_logo_estu_2 = QLabel(self.widget)
        self.lblTitulo_logo_estu_2.setObjectName(u"lblTitulo_logo_estu_2")
        self.lblTitulo_logo_estu_2.setGeometry(QRect(65, 20, 231, 80))
        self.lblTitulo_logo_estu_2.setMinimumSize(QSize(231, 80))
        self.lblTitulo_logo_estu_2.setMaximumSize(QSize(231, 80))
        font4 = QFont()
        font4.setFamilies([u"Segoe UI"])
        font4.setPointSize(19)
        font4.setBold(True)
        self.lblTitulo_logo_estu_2.setFont(font4)
