...
################################################################################
## Form generated from reading UI file 'gestion_materias_1024x600.ui'
##
...
class Ui_gestion_materias(object):
    def setupUi(self, gestion_materias):
        ...
        gestion_materias.resize(841, 511)
        gestion_materias.setMinimumSize(QSize(841, 511))
        gestion_materias.setMaximumSize(QSize(841, 511))
...
"color: #2d2d2d;")
        ...
        self.frameHeader.setMaximumSize(QSize(821, 81))
...
"}")
        ...
        self.lblTitulo_materias.setMinimumSize(QSize(120, 0))
        self.lblTitulo_materias.setMaximumSize(QSize(140, 60))
        font2 = QFont()
...
"background-color: transparent;")
        ...
        self.frameHeader_2.setMaximumSize(QSize(821, 51))
...
"}")
        ...
        self.frameTabla_materias.setMinimumSize(QSize(821, 290))
        self.frameTabla_materias.setMaximumSize(QSize(821, 401))
...
"}")
        ...
        self.frameSaludo_2.setMaximumSize(QSize(16777215, 50))
