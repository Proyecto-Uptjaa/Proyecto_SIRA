...
class DetallesEstudiante(QDialog, Ui_ficha_estu):
    ...
    def set_campos_editables(self, estado: bool):
        campos = [
            ...
            self.lneMadre_ficha_estu, self.lnePadre_ficha_estu, self.lneCedula_madre_ficha_estu,
        ...
        campos_solo_lectura = [self.lneEdad_ficha_estu, self.lneEdad_repre_ficha_estu]
